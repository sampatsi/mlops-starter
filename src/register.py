...
def main(args):
    ...
    print(
        f"Registered model version: name={args.model_name} "
...
if __name__ == "__main__":
    ...
    p.add_argument(
        "--metric", default="f1",
        help="metric to check before registering"
    )
    p.add_argument(
        "--min-improve", type=float, default=0.0,
        help="(reserved) min delta to consider"
    )
